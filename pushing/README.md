...
The purpose of this method was primarily to provide efficient samples of regular triangulations, not biased by
the Delaunay triangulation. This makes CYTools' `random_triangulations_fast` (which generates triangulations
by adding Gaussian noise to the Delaunay heights) an interesting comparison point. The methods in this repo (labeled `rfp`) show better timing than `random_triangulations_fast` and a notably different population. See
following plots (generated by `compare_to_cytools_triang_fast.py`).

<p align="center">
  <img src="docs/compare_timing.png" alt="Timing: rfp vs CYTools random_triangulations_fast"/>
</p>

For a comparison of the triangulation populations, see [below](#triangulation-population-comparison).
...
<p align="center">
  <img src="docs/compare_grid.png" alt="rfp vs CYTools random_triangulations_fast: sample triangulations"/>
</p>
